...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPetContentUri = getIntent().getData();
        ...
        mGenderSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(PetEntry.GENDER_MALE)) {
                        mGender = PetEntry.GENDER_MALE; // Male
                    } else if (selection.equals(PetEntry.GENDER_FEMALE)) {
    ...
    private void savePet() {
        ...
        String nameBreed = mBreedEditText.getText().toString().trim();
        int gender = mGender;
        String weightString = mWeightEditText.getText().toString().trim();

        if (mPetContentUri == null &&
                TextUtils.isEmpty(nameString) && TextUtils.isEmpty(nameBreed) &&
        ...
        values.put(PetEntry.COLUMN_PET_BREED, nameBreed);
    ...
    private void deletePet() {
        if (mPetContentUri != null) {
            ...
            int rowsDeleted = getContentResolver().delete(mPetContentUri, null, null);
